...
//No tiene sentido que definas aquí el jugador si lo defines después debajo en el constructor. 
	...
	public principal() {
		...
		//Creo que el problema es una confusión al llamar a los diferentes campos de texto. Al respecto siempre es conveniente ponerles nombres que nos ayuden, por ejemplo al campo de texto donde voy a poner el nombre yo lo llamaría textField_nombre, y así sucesivamente.
		...
		//Si tu campo de texto para nombre es textField_1 por tanto debería ser
		...
		//es textField_2 y quieres rellenar apellidos sería
		//Al hacer intro se rellena campo
		...
		//es textField_3 y quieres rellenar apellidos sería
		//player1.setNombre(textField.getText())	;
		...
		//Haciéndolo bien en los anteriores listeners para cada campo de texto estas 3 líneas sobran.
		//player1.setNombre(textField_1.getText());
		//player1.setApellidos(textField_2.getText());
		//player1.setLocalidad(textField_3.getText());
